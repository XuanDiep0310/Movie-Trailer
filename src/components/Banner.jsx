...
const Banner = () => {
  return (
    <div className="h-[600px] w-full bg-cover bg-center bg-no-repeat relative banner-custom">
      ...
      <div className='w-full h-full flex items-center justify-center space-x-[30px] p-4 relative z-20'>
        ...
        <div className='w-[50%] flex items-center justify-center'>
          <div className='w-[300px] h-[400px] relative group cursor-pointer'>
            ...
            <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center backdrop-blur-xs opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out'>
